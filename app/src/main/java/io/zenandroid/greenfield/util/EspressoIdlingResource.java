...
package io.zenandroid.greenfield.util;
...
public final class EspressoIdlingResource implements IdlingResource {
    ...
    private static final EspressoIdlingResource INSTANCE = new EspressoIdlingResource("GLOBAL");
    ...
    /**
     * Creates a EspressoIdlingResource
     *
     * @param resourceName the resource name this resource should report to Espresso.
     */
    private EspressoIdlingResource(String resourceName) {
